...
class EditResult : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        result = resultList[pos]
        findViewById<EditText>(R.id.titleFieldId).setText(result.title)
        findViewById<EditText>(R.id.gameFieldId).setText(result.game)
        findViewById<EditText>(R.id.targetFieldId).setText(result.target)
        findViewById<EditText>(R.id.diffFieldId).setText(result.diff)
        findViewById<EditText>(R.id.subFieldId).setText(result.sub)
        ...
        saveButton.setOnClickListener {
            ...
            val str = Gson().toJson(resultList)
